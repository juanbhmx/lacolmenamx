                ...
                <div className="Content">
                    <div className="PlaceOrderWrapper">
                        ...
                        <div className="DeliveryAddress">
                            ...
                            <div className="Card">
                                <p className="CardText">Login <i className="fas fa-check"></i> : </p>
                                <p className="CardText">Email:</p>
                            </div>

                            {
                                this.state.isAddressConfirm ? 
                                 <div className="Card">
                                     <p className="CardText">Direccion de Entrega {this.state.isAddressConfirm ? <i className="fas fa-check"></i> : null}</p>
                                     <p>
                                ...
                                <div className="Card">
                                    ...
                                    }
                                    {
                                        ...
                                        <div className="DeliveryButtonContainer" >
                                            <button onClick={this.confirmDeliveryAddress} className="DeliveryAddressButton">Entregar Aqui</button>
                                        </div> : null
                                    }
                                ...
                                <div className="Card">
                                    ...
                                    <Route>
                                        <Link to="/checkout"><i className="fas fa-shopping-cart"><button className="DeliveryAddressButton" >GUARDAR Y ENTREGAR AQUI</button></i></Link>
                                ...
                                {this.state.isOrderConfirm ? 
                                    <div className="Card">
                                        <p className="CardText">Resumen Orden <i className="fas fa-check"></i> </p>
                                    </div> : 
                                    this.state.isAddressConfirm ? 
                                    <div className="Card">
                                        <h4 className="CardText">Resumen Orden  </h4>
                                        {
                                        ...
                                        <button onClick={this.confirmOrder} className="ContinueButton">Continuar</button>
                                    </div>
                                 : null
                                }
                                
                                {
                                    this.state.isOrderConfirm ? 
                                    <div className="Card">
                                    <h4 className="CardText">Opciones de Pago</h4>
                                    <ul>
                                        {
                                    ...
                                    </ul>
                                    {
                                        ...
                                        <p className="ErrorMessage">Lo sentimos, ocurrio un error.</p> : null
                                    }
                                    <button className="PaymentConfirm" onClick={this.submitOrder}>Confirmar Orden</button>
